...
import { DownloadOfflineAction } from '/@/renderer/features/context-menu/actions/download-offline-action';
...
export const PlaylistContextMenu = ({ items, type }: PlaylistContextMenuProps) => {
    ...
    return (
        ...
        >
            ...
            <ContextMenu.Divider />
            <DownloadOfflineAction items={items} itemType={LibraryItem.PLAYLIST} />
            <ContextMenu.Divider />
